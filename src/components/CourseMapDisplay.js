...
function CourseMapDisplay(props) {
    ...
    const findTotalGenEdCredits = () => {
        let sum = 0

        sum = findTotalCreditsByType("NS") + 
        findTotalCreditsByType("HFA") + 
        findTotalCreditsByType("SBS") + 
        findTotalCreditsByType("WOC")
            ...
            <Card mt={3}>
                ...
                <List spacing={3} mt={4} size={"lg"}>
                    ...
                    <ListItem>
                        ...
                        <b>Total Credits are {findTotalCredits()} out of 120</b> 
                    </ListItem>
                    <ListItem>
                        {findTotalCreditsByDiscipline("Cmp Sci")>=74 &&<ListIcon as={MdCheckCircle} color='green.500' />}
                        {findTotalCreditsByDiscipline("Cmp Sci")< 74  &&<ListIcon as={MdClose} color='red.500' />}
                        Computer sciences credits are {findTotalCreditsByDiscipline("Cmp Sci")} out of 74 
                    </ListItem>
                    <ListItem>
                        {findTotalCreditsByType("MS")>=19 &&<ListIcon as={MdCheckCircle} color='green.500' />}
                        {findTotalCreditsByType("MS")< 19  &&<ListIcon as={MdClose} color='red.500' />}
                        Mathematical sciences credits are {findTotalCreditsByType("MS")} out of 19 
                    </ListItem>
                    <ListItem>
                        {findTotalGenEdCredits()>=27 &&<ListIcon as={MdCheckCircle} color='green.500' />}
                        {findTotalGenEdCredits()< 27  &&<ListIcon as={MdClose} color='red.500' />}
                        <b>Total General Education(NS,HFA,SBS and WOC) Credits are {findTotalGenEdCredits()} out of 27 </b>
                    </ListItem>
                    <ListItem>
                        {findTotalCreditsByType("NS")>=4 &&<ListIcon as={MdCheckCircle} color='green.500' />}
                        {findTotalCreditsByType("NS")< 4  &&<ListIcon as={MdClose} color='red.500' />}
                        Natural sciences credits are {findTotalCreditsByType("NS")} out of 4 including a lab course
                    </ListItem>
                    <ListItem>
                        {findTotalCreditsByType("HFA")>=5 &&<ListIcon as={MdCheckCircle} color='green.500' />}
                        {findTotalCreditsByType("HFA")< 5  &&<ListIcon as={MdClose} color='red.500' />}
                        Humanities and fine arts credits are {findTotalCreditsByType("HFA")} out of 5 
                    </ListItem>
                    <ListItem>
                    ...
                    <ListItem>
                        ...
                        Written and oral communications credits are {findTotalCreditsByType("WOC")} out of 9 
                    </ListItem>
